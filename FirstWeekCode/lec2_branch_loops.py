...
## --------- ----------
print ("            ")
print ("** Rutina para calcular con base en 10 entradas **")
print ("   **   cual es el número par mas grande   **    ")
print ("   **  si no hay números impares se indica **     ")
print ("            ")
##
## variables de inicio
## --------- -----------
c=1          # contador de iteracciones
anterior = 0 # valor del número anterior a comparar
impar = 0    # contador de números impares
par = 0      # contador de numeros pares
## --------- -----------
## inicio de la lógica de la rutina
## --------- -----------
while c <= 3:
    num = int(input("Ingrese el número : "+str(c)+" --> "))
    if num % 2 == 0:
